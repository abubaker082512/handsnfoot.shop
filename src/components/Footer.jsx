                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-gray-400">
                            <li className="flex items-center space-x-2">
                                ...
                                <span>info@handsnfoot.shop</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span>+92-328-0801100</span>
                            </li>
                            <li className="flex items-start space-x-2">
                                ...
                                <span>G-20, Mobile Arena, SOAN Avenue Road, SOAN Garden, Islamabad</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-gray-400">
                            ...
                            <span className="hidden md:inline">•</span>
                            <Link to="/refund-policy" className="hover:text-primary-400 transition-colors">
                                Refund Policy
                            </Link>
                            <span className="hidden md:inline">•</span>
                            <Link to="/shipping-policy" className="hover:text-primary-400 transition-colors">
                                Shipping Policy
                            </Link>
                            <span className="hidden md:inline">•</span>
